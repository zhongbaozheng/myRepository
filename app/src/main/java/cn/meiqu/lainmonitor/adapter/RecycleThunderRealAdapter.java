...
public class RecycleThunderRealAdapter extends BaseRecycleAdapter {
    private Context mContent;
    private ArrayList<Thunder> thunders;

    public RecycleThunderRealAdapter(Context mContent, ArrayList<Thunder> thunders) {
    ...
    class Holder extends BaseHolder implements RippleView.OnRippleCompleteListener {
        ...
        public void instanceView(final int position) {
            Thunder water = thunders.get(position);
