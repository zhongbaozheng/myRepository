...
public class RecycleAlertType1Adapter extends BaseRecycleAdapter {
    private Context mContent;
    private ArrayList<AlertType1> AlertType1s;


    public RecycleAlertType1Adapter(Context mContent, ArrayList<AlertType1> AlertType1s) {
        this.mContent = mContent;
        this.AlertType1s = AlertType1s;
    }
    ...
    class Holder extends BaseHolder implements View.OnClickListener {
        ...
        public void instanceView(final int position) {
            ...
            AlertType1 AlertType1 = AlertType1s.get(position);
            mTvAddr.setText(AlertType1.getLocation() + "");
            mTvName.setText(AlertType1.getName() + "");
            mTvInfo.setText(AlertType1.getInfo() + "");
            mTvTime.setText(AlertType1.getTime() + "");
        }
