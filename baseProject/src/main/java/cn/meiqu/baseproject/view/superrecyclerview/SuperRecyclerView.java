package cn.meiqu.baseproject.view.superrecyclerview;
...
import cn.meiqu.baseproject.view.superrecyclerview.swipe.SwipeDismissRecyclerViewTouchListener;
...
//            mMoreProgressId = a.getResourceId(R.styleable.superrecyclerview_layout_moreProgress, R.layout.layout_more_progress);
            mMoreProgressId = R.layout.layout_recycle_loadmore;
     ...
     * If adapter is empty, then the emptyview_data is shown
     *
     * @param adapter
     */
...
////            mEmpty.setLayoutResource(R.layout.emptyview_data);
//            ((ImageView) (((ViewGroup) mEmptyView).getChildAt(0))).setImageResource(R.drawable.img_nodata);
//            ((TextView) (((ViewGroup) mEmptyView).getChildAt(1))).setText(R.string.empty_nodata);
//
//        } else {
////            mEmpty.setLayoutResource(R.layout.emptyview_network);
//            ((ImageView) (((ViewGroup) mEmptyView).getChildAt(0))).setImageResource(R.drawable.img_network_failure);
//            ((TextView) (((ViewGroup) mEmptyView).getChildAt(1))).setText(R.string.empty_network);
//        }
    }
    ...
    public void setRefreshing(boolean b) {
        getSwipeToRefresh().setRefreshing(b);
        hideMoreProgress();
    }
